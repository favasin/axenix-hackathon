...
const Fa = (t) => (Td(), Ee.sanitize(t)), Zo = (t, e) => {
  ...
  const { default: i } = await import("./katex-d90b6d29.min.js");
...
const Fr = (t, e) => {
  ...
  const { diagram: t } = await import("./c4Diagram-e65f60cc.min.js");
  ...
  const { diagram: t } = await import("./flowDiagram-d3710025.min.js");
  ...
  const { diagram: t } = await import("./flowDiagram-v2-8dd8b966.min.js");
  ...
  const { diagram: t } = await import("./erDiagram-88ff80f2.min.js");
  ...
  const { diagram: t } = await import("./gitGraphDiagram-e4279c54.min.js");
  ...
  const { diagram: t } = await import("./ganttDiagram-d5eca442.min.js");
  ...
  const { diagram: t } = await import("./infoDiagram-6f84184f.min.js");
  ...
  const { diagram: t } = await import("./pieDiagram-fdb04870.min.js");
  ...
  const { diagram: t } = await import("./quadrantDiagram-acae359b.min.js");
  ...
  const { diagram: t } = await import("./xychartDiagram-2c3c3b85.min.js");
  ...
  const { diagram: t } = await import("./requirementDiagram-fc9445a3.min.js");
  ...
  const { diagram: t } = await import("./sequenceDiagram-a3c91cc7.min.js");
  return { id: Bl, diagram: t };
}, Qy = {
  id: Bl,
  detector: Zy,
  ...
  const { diagram: t } = await import("./classDiagram-9faaf380.min.js");
  ...
  const { diagram: t } = await import("./classDiagram-v2-8d50f991.min.js");
  ...
  const { diagram: t } = await import("./stateDiagram-654cced9.min.js");
  ...
  const { diagram: t } = await import("./stateDiagram-v2-140258dc.min.js");
  ...
  const { diagram: t } = await import("./journeyDiagram-b15fc9d2.min.js");
  return { id: Ml, diagram: t };
}, C_ = {
  id: Ml,
  detector: y_,
...
`);
  ...
  const { diagram: t } = await import("./flowchart-elk-definition-34365f60.min.js");
  ...
  const { diagram: t } = await import("./timeline-definition-d879e019.min.js");
  ...
  const { diagram: t } = await import("./mindmap-definition-2aab62ef.min.js");
  ...
  const { diagram: t } = await import("./sankeyDiagram-9fcf3781.min.js");
  ...
  const { diagram: t } = await import("./blockDiagram-48276afd.min.js");
