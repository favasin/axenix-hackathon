...
> ⚠️ **ТРЕБУЕТ УТОЧНЕНИЯ:** В финальной версии `AppPreview` должен содержать реальный скриншот или анимированное превью интерфейса. Текущий скриншот — placeholder.
...
> ⚠️ **ТРЕБУЕТ УТОЧНЕНИЯ:** Поведение кнопки «Посмотреть как работает» — якорная ссылка (`#how-it-works`) или видео-модал. На текущем скриншоте секция ниже AppPreview не видна.

> ⚠️ **ТРЕБУЕТ УТОЧНЕНИЯ:** Скролл-секции ниже fold (Возможности, Тарифы, Как это работает) не представлены на скриншоте.
